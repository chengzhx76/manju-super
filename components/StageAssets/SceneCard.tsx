...
import { SceneGenerationHistoryItem } from '../../types'
...
const SceneCard: React.FC<SceneCardProps> = ({
  ...
  const generationHistory: SceneGenerationHistoryItem[] =
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-[var(--border-primary)] flex-1 flex flex-col">
        ...
        <div className="mt-auto pt-3 border-[var(--border-primary)] flex flex-col gap-2">
            ...
            {generationHistory.length === 0 ? (
              ...
              <div className="flex gap-2 h-[74px] overflow-x-auto overflow-y-hidden pb-1">
                {generationHistory.map((item, index) => {
                  const isActiveHistoryItem = item.imageUrl === scene.referenceImage
                  return (
                    <div
                      key={item.id}
