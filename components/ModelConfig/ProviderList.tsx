    ...
    showAlert(`确定要删除供应商「${provider.name}」吗？`, {
      ...
      onConfirm: () => {
        if (removeProvider(provider.id)) {
          ...
          showAlert('无法删除：该供应商下可能仍有模型，请先删除关联模型', {
            type: 'error'
          })
        }
      }
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        {providers.map((provider) => {
          const usedModelsCount = models.filter(
              ...
              <div className="p-4 flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`text-[10px] ${usedModelsCount > 0 ? 'text-[var(--accent)]' : 'text-[var(--text-tertiary)]'}`}
                    >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={
                      !provider.apiKey || verifyingProviderId === provider.id
                    }
