...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="fixed top-0 left-0 h-screen z-50 group pointer-events-none">
      <aside
        className={`pointer-events-auto w-72 bg-[var(--bg-base)] border-r border-[var(--border-primary)] h-full absolute left-0 top-0 flex flex-col select-none transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
