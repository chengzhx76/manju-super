...
export const formatPayableAmount = (
  amount: number | null,
  status: NewApiStatus | null
) => {
...
export const normalizePayMethods = (
  value: NewApiPayMethod[] | string | undefined
): NewApiPayMethod[] => {
  if (!value) return []
